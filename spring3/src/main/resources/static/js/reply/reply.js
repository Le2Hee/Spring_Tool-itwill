        ...
        for (let reply of data) { // for - of : 배열에서 하나씩 꺼내서 reply에 채워준다.
            ...
            htmlStr += `
                ...
                <div class="card my-2">
                    ...
                    <div>
                        <textarea class="replyContent form-control my-2" id="replyText_${reply.id}" readonly>${reply.replyText}</textarea>
                    </div>
            `;
            
            // 로그인한 사용자와 댓글 작성자가 같을 때만 삭제, 수정 버튼을 보여줌.
            if (authName.value === reply.writer) {
